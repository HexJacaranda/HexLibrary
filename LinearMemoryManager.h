		...
		namespace Collection
		{
			...
			public:
				...
				LinearMemoryManager(LinearMemoryManager && lhs)noexcept :Memory::AllocatorSupporter(nullptr) {
					Utility::object_move(this->Allocator, lhs.Allocator);
					Utility::object_move(this->m_data, lhs.m_data);
					Utility::object_move(this->m_total_count, lhs.m_total_count);
					Utility::object_move(this->m_used_count, lhs.m_used_count);
					Utility::object_move(this->m_increasing_factor, lhs.m_increasing_factor);
				}
